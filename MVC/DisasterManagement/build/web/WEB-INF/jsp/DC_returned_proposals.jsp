...
<html>
    <head>
        ...
        <title>Rejected Proposals | DRMS</title>
                ...
                <div id="layoutSidenav_content">
                    <main>
                        <div class="container-fluid px-4">
                            <h1 class="mt-4 mb-4">Proposals Rejected By Revenue</h1>
                            <!--Page Content Start-->
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h5 class="text-center">List Of Proposals Returned By Revenue Department</h5>
                            </div>
                            <div class="card-body">
...
//                                                                                                    alert(sanc);
                                                                                                    return $.ajax({
                                                                                                        url: './forwardrejectedproposaltorevenue.htm',
