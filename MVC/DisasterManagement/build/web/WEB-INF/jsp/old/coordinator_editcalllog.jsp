            ...
            <c:import url="/nav_side.htm"></c:import>
                <div id="layoutSidenav_content">
                    <main>
                        ...
                        <form:form modelAttribute="pcscreen" method="POST" name="pcrscreen" id="pcrscreen">
                            <div class="card mt-4">
                                <div class="card-body">
                                    <div class="row mb-3">
                                        <div class="col-md-4">
                                            <div class="form-floating mb-3">
                                                <form:input type="text" id="caseno" path="basic_casedetails.caseno" class="form-control" placeholder="Enter Case Number" />
...
//                                                        document.getElementById("callertype").value = callertype;
//                                                        var str = $('form[name=pcrscreen]').serialize();
//                                                        str = str.replace(/%5B/g, "[");
//                                                        str = str.replace(/%5D/g, "]");
//                                                        $.ajax({
//                                                            type: "POST",
//                                                            url: "./saveeditcall_log.htm",
//                                                            data: str,
//                                                            processData: false,
//                                                                            contentType: false,
...
//                                                                console.log(res);
                                            ...
                                            function gotoCaseManagement() {
                                                ...
                                                window.location.href = "caseindex.htm?caseno=" + cn + "&districtselected=" + districtselected;
                                            }
