                    ...
                    <main>
                        <div class="container-fluid px-4">
                            ...
                            <ul class="nav nav-tabs mt-4">
                                <li class="nav-item">
                                    <a href="#complainantdetails" class="nav-link active" data-bs-toggle="tab">Complainant Details (View Only)</a>
                                </li>
                                <li class="nav-item">
                                    <a href="#complaintdetails" class="nav-link" data-bs-toggle="tab">Complaint Details</a>
                                </li>
                                <li class="nav-item">
                        ...
                        <form:form modelAttribute="editcasec" autocomplete="off" id="editCaseForm">
                            <div class="tab-content scrollcontainer">
                                ...
                                <div class="pt-3 tab-pane fade bg-light cardborder mb-2" id="complaintdetails">
...
//                                                                                    clearAccusedDetails();
                                                                                    ...
                                                                                    self.setContent('Could not add details.');
                                                                                    self.setTitle('Error!');
                                                                                }
                                                                            }).fail(function () {
