                    ...
                    <main>
                        <div class="container-fluid px-4 pb-4">
                            ...
                            <form autocomplete="off" id="emailForm" enctype="multipart/form-data">
                                <input type="hidden" value="<c:out value="${basic_casedetails.caseno}" />" name="basiccaseno" id="inputCaseNoRO" />
                            <div class="row mt-4">
                                <div class="col">
                                    <div class="card mb-3">
                                        <div class="card-body">
                                            <div id="agencyBlock">
                                                ...
                                                <input type="hidden" name="cagencydetailid" id="cagencydetailid" class="form-control"/>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row d-none" id="withFollowupDiv">
                                            <form id="followupForm" autocomplete="off">
                                                <div class="col">
                                                    <label for="calllogidt">Call Log ID:</label>
                                                    <input type="text" readonly="true" id="calllogidt" name="calllogidt" class="form-control"/>
                                                </div>
                                                <div class="col-12">
                                                    <div class="form-floating mb-3">
                                        ...
                                        <div class="row d-none" id="withoutFollowupDiv">
                                            <div class="col-12">
                                                <button type="button" class="btn btn-danger" onclick="closeModalReload();" id="withoutFollowupBTN">No Need To Follow Up. Close</button>
                                            </div>
                                        </div>
...
//                                                        var basicCaseDetails = document.getElementById("basiccasedetails").innerHTML;
//                                                        var inputContent = document.getElementById("inputContent");
//                                                        inputContent.innerHTML += basicCaseDetails;
                                                    ...
                                                    function closeModalReload() {
                                                        var csrfHeader = $("meta[name='_csrf_header']").attr("content");
                                                        var csrfToken = $("meta[name='_csrf']").attr("content");
                                                        var callogid = $('#calllogidt').val();
                                                        $.confirm({
                                                            content: function () {
                                                                var self = this;
                                                                return $.ajax({
                                                                    url: './savenofollowup.htm',
                                                                    method: 'POST',
                                                                    data: "calllogidt=" + callogid,
                                                                    beforeSend: function (xhr) {
                                                                        xhr.setRequestHeader(csrfHeader, csrfToken);
                                                                    }
                                                                }).done(function (response) {
                                                                    if (response === "1") {
                                                                        ck = 1;
                                                                        self.setTitle('Success!');
                                                                        self.setContent('Marked case without folloup.');
                                                                    } else {
                                                                        ck = 0;
                                                                        self.setTitle('Failed!');
                                                                        self.setContent('Failed to mark case wuthout followup.');
                                                                    }
                                                                }).fail(function () {
                                                                    self.setTitle('');
                                                                    self.setContent('Something went wrong.');
                                                    ...
                                                    function setContactAgency(cagencydetailid) {
                                                        $('#cagencydetailid').val(cagencydetailid);
                                                    }
        </script>
    </body>
</html>
