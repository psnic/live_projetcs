                    ...
                    <main>
                        <div class="container-fluid px-4">
                            ...
                            <div class="col-lg-3 col-6">
                                ...
                                <div class="small-box bg-whatev">
                                    <div class="inner">
                                        <h3 class="text-light">${prv_count}</h3>
                            ...
                            <div class="col-lg-3 col-6">
                                ...
                                <div class="small-box bg-whatev">
                                    <div class="inner">
                                        ...
                                        <p class="text-light">Pending Proposals with Comm. Secretary</p>
                                    </div>
                                    <div class="icon">
                                        <i class="fa-solid fa-clipboard-list"></i>
                                    </div>
                                    <a href="cs_pending.htm" class="small-box-footer">View More <i class="fas fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                            <div class="col-lg-3 col-6">
                                <!-- small box -->
                                <div class="small-box bg-green">
                                    <div class="inner">
                                        ...
                                        <p class="text-light">Approved Proposals</p>
                                    </div>
                                    <div class="icon">
