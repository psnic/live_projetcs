                ...
                <div id="layoutSidenav_content">
                    <main>
                        <div class="container-fluid px-4">
                            <h1 class="mt-4 mb-4">Approved Proposals By Commissioner Secretary</h1>
                            <!--Page Content Start-->
                                                    ...
                                                    <td>
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${(LOGIN.role_code.role_code == '5')}">
                                                                <!--<button class="btn btn-success btn-sm btn-block mt-1" onclick="viewAgendaNote();">&nbsp;Generate Agenda Note&nbsp;</button>-->
                                                            </c:when>
                                                        </c:choose>
                                                    </td>
                                                </tr>
