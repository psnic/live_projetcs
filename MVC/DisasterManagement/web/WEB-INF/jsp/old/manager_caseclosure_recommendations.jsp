            ...
            <c:import url="/nav_side.htm"></c:import>
                <div id="layoutSidenav_content">
                    ...
                    <div class="container-fluid px-4">
                        <div class="card mt-4">
                            <div class="card-header bg-purple text-center"><h4 class="text-white py-2">Cases Recommended For Final Closure</h4></div>
                            <div class="card-body">
                                <table class="table table-bordered table-striped" id="closedCaseTable">
                                    ...
                                    <tbody>
                                        <c:forEach var="v" items="${caseclosurerecommendations}" varStatus="i">
                                            <tr class='fake-btn' onclick="caseindex('<c:out value="${v[0]}"></c:out>');">
                                                <td><c:out value="${i.count}"></c:out></td>
                                                <td><c:out value="${v[0]}"></c:out></td>
                                                <td><c:out value="${v[2]}"></c:out></td>
                                                </tr>
                                        </c:forEach>
                                    </tbody>
                                </table>
