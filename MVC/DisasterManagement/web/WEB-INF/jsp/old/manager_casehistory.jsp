...
<html>
    <head>
        ...
        <script src="suantonsing/js/moment.js" type="text/javascript"></script>
        <style>
            .audioplaya {
                width: 70%;
            }
    ...
    <body>
                                    ...
                                    <div class="cmilist" style="font-family: 'Times New Roman',Times, serif;">
                                        <div class="list-title">
                                            <p class="fw-bold mb-0">
                                                <!--<input type="hidden" id="cda_${i}" value="<c:out value="${c.call_date}" />" />-->
                                                <input type="hidden" id="cda_${i}" value="<c:out value="${empty c.call_date ? c.entrydate : c.call_date}" />" />
                                                <span id="calldate_ago_${i}"></span>
                                                <script>
                                                    var ord = $('#cda_${i}').val();
                                                    var mdt = moment(ord).format('MM/DD/YYYY  HH:mm:ss');
                                                    var dc = moment(mdt).fromNow();
                                                    $('#calldate_ago_${i}').html(dc);
                                                </script><br/>
                                        ...
                                        <div class="list-content">
                                            ...
                                            <c:if test="${fn:length(c.file)>1}">
                                                <c:forEach varStatus="l2" var="d" items="${doclist}">
                                                    <c:if test="${l1.index eq l2.index}">
                                                        <c:choose>
                                                            <c:when test="${d[0] == 'audio'}">
                                                                <div class="list-title">
                                                                    Local Voice Files:<br>                                              
                                                                    <div class="d-flex flex-row justify-content-between align-content-center align-items-center">

                                                                        <audio seeking="true" id="ap_${d[0]}" class="audioplaya" controls src="<c:out escapeXml='true' value='${d[2]}'/>"></audio>
                                                                        <a class="btn btn-sm btn-purple text-white" download="audio-file" id="audioRecordDownload_${c.call_logid}" href="<c:out escapeXml="true" value="${d[2]}"/>">
                                                                            <i class="fa-solid fa-download"></i>&nbsp;&nbsp;<span class="text-white">Download audio</span>
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                                <br/>
                                                            ...
                                                            <c:otherwise>
                                                                <a target="_blank" href="viewdocument.htm?callogid=<c:out escapeXml="true" value="${d[1]}" />" class="btn btn-primary">View Document</a>
                                                                <br/>
                                                            </c:otherwise>
                                                        </c:choose> 
                                                    </c:if>                           
                                    ...
                                    <div class="cmilist" style="font-family: 'Times New Roman',Times, serif;">
                                        <div class="list-title">
                                            <p class="fw-bold mb-0">
                                                ...
                                                <c:choose>
                                                    <c:when test="${empty c.call_date}">
                                                        <c:out value="${c.entrydate}" />
                                                    </c:when>
                                                    <c:otherwise>
                                                        <c:out value="${c.call_date}" />
                                                    </c:otherwise>
        ...
        <script>
                                                    ...
                                                    function editcalllog(calllogid) {
                                                        window.location.href = 'editcalllog.htm?caseno=' + caseno.trim() + '&call_logid=' + calllogid;
                                                    }
