...
<html>
    ...
    <body>
        <div class="card">
            <div class="card-title bg-181 text-center fw-bold p-2">Case History</div>
            <div class="card-body">
                    ...
                    <div class="pt-3 tab-pane fade show active cardcontainer" id="basiccasedetails">
                        <div class="cmilist">
                            ...
                            <div class="list-content" style="font-family: 'Times New Roman',Times, serif;">
                                ...
                                Case Registration Date: <c:out value="${basic_casedetails.casedate}" /><br>
                                                    ...
                                                    <c:if test="${l1.index eq l2.index}">
                                                        <div class="list-title">
                                                            ...
                                                            <div class="d-flex flex-row justify-content-between align-content-center align-items-center">
                                                                ...
                                                                <audio seeking="true" id="ap_${c.call_logid}" class="audioplaya" controls src="<c:out escapeXml='true' value='${ax}'/>"></audio>
                                                                <a class="btn btn-sm btn-purple text-white" download="audio-file" id="audioRecordDownload_${c.call_logid}" href="<c:out escapeXml="true" value="${ax}"/>">
