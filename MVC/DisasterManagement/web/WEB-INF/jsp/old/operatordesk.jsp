                                    ...
                                    <tbody id="cllHistBody">
                                        <c:forEach items="${call_history}" varStatus="x" var="c">
                                            <tr>
                                                ...
                                                <td><fmt:formatDate type="both" timeStyle="short" dateStyle="medium" pattern="dd, MMM yyyy - hh:mm a" value="${c.call_date}" /></td>
                                                <td><c:out escapeXml="true" value="${c.phoneno}" /></td>
                                                <td><c:out escapeXml="true" value="${c.m_calltype.calltypedesc}" /></td>
                                                <td><c:out escapeXml="true" value="${c.m_call.calldesc}" /></td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
                                </table>
                        ...
                        <div class="container mt-3 mb-2">
                            <div class="card">
                                <div class="card-header bg-purple">
                                    <h4 class="text-white text-center fw-bold font-size-lg">Operator Desk</h4>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
